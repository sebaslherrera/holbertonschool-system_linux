...
/**
 * get_permissions - Permissions used in ls listing format
 * @st_mode: Protection field of struct stat
 *
...
/**
 * get_type_of_file - Used to identify the type of file
 * @st_mode: Protection field of struct stat
 * @permissions: Pointer of char permissions
 *
 * Return: String of permissions
 */
char *get_type_of_file(unsigned int st_mode, char *permissions)
...
/**
 * get_rights_of_file - Used to identify the rights of file
 * @st_mode: Protection field of struct stat
 * @permissions: Pointer of char permissions
 *
 * Return: Char pointer of permissions
 */
char *get_rights_of_file(unsigned int st_mode, char *permissions)
{
	/* Owner permissions */
